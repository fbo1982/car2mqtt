...
class GwmProvider(BaseProvider):
    ...
    def validate_config(self, provider_config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "polling_enabled": bool(provider_config.get("polling_enabled", True)),
            ...
            "delayed_retry_enabled": bool(provider_config.get("delayed_retry_enabled", True)),
            "retry_delay_minutes": int(provider_config.get("retry_delay_minutes", 55) or 55),
            "fallback_on_silence": bool(provider_config.get("fallback_on_silence", True)),
        }
