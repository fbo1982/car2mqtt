...
- ORA-Codefeld + Senden wie in 0.7.1.
...
## V0.7.1
- Herstellerliste erweitert: Tesla, VW, Skoda, SEAT, Cupra, Opel, Citroën, DS, Peugeot, Hyundai, Kia, Mercedes-Benz.
- Audi, BYD und Lucid als `Coming soon` aufgenommen.
- Für Phase 1+2 Hersteller wurden vorbereitete Konfigurationsmasken für Create/Edit ergänzt.
- BMW und GWM/ORA bleiben die aktuell funktionsfähigen Laufzeitprovider.


## V0.7.1
- BMW MQTT Raw Topic enthält keine VIN mehr.
- Interne ID wird automatisch aus dem Kennzeichen ohne Sonderzeichen erzeugt.
- Gilt für Fahrzeug anlegen und bearbeiten.
